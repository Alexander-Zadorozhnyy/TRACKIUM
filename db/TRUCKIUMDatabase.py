...
import psycopg2
from TRUCKIUM.db.config import host, user, password, db_name
...
if __name__ == '__main__':
    ...
    db.reset_database()
    # db.insert_user_to_database(("adam", "user@yandex.ru", "123user456"))
    # print(db.get_cars(39))
    # db.test()
    # db.delete_car_from_database(1)
    # db.insert_car_to_database((1, "Alex", "+79096119673", date.today(), "A098BT56"))
    # db.delete_user_from_database("user@ywerandex.ru")
    # db.insert_deal_to_database((1, 1, "Moscow", "Saint-Peterburg", "IEEE", 250000, date.today()))
    # db.insert_income_to_database((1, 3, 1, "Amarov", 35000, date.today(), True))
    # db.insert_expense_to_database((1, 4, 15000, date.today(), True, "Fix road"))
